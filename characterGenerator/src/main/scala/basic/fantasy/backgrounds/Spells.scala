...
object Spells {
  ...
  case object ContinualLight extends Spell("Continual Light", "360'", "1 year/level", Some(ContinualDarkness))
  case object ContinualDarkness extends Spell("Continual Light", "360'", "1 year/level", Some(ContinualLight))
  ...
  case object CureDisease extends Spell("Cure Disease", "touch", "instantaneous", Some(CauseDisease))
  case object CauseDisease extends Spell("Cause Disease", "touch", "instantaneous", Some(CureDisease))
  case object CureLightWounds extends Spell("Cure Light Wounds", "touch", "instantaneous", Some(CauseLightWounds))
  case object CauseLightWounds extends Spell("Cause Light Wounds", "touch", "instantaneous", Some(CureLightWounds))
  case object CureSeriousWounds extends Spell("Cure Serious Wounds", "touch", "instantaneous", Some(CauseSeriousWounds))
  case object CauseSeriousWounds extends Spell("Cause Serious Wounds", "touch", "instantaneous", Some(CureSeriousWounds))
  ...
  case object DetectEvil extends Spell("Detect Evil", "60'", "1 round/level", Some(DetectGood))
  case object DetectGood extends Spell("Detect Good", "60'", "1 round/level", Some(DetectEvil))
  ...
  case object FleshToStone extends Spell("Flesh To Stone", "30'/level", "permanent", Some(StoneToFlesh))
  case object StoneToFlesh extends Spell("Flesh To Stone", "30'/level", "permanent", Some(FleshToStone))
  ...
  case object Geas extends Spell("Geas", "5 foot/level", "special", Some(RemoveGeas))
  ...
  case object GrowthOfPlants extends Spell("Growth Of Plants", "120'", "permanent", Some(ShrinkPlants))
  case object ShrinkPlants extends Spell("Growth Of Plants", "120'", "permanent", Some(GrowthOfPlants))
  ...
  case object Poison extends Spell("Poison", "touch", "instantaneous", Some(NeutralizePoison))
  ...
  case object RaiseDead extends Spell("Raise Dead", "touch", "instantaneous", Some(SlayLiving))
  case object SlayLiving extends Spell("Slay Living", "touch", "instantaneous", Some(RaiseDead))
